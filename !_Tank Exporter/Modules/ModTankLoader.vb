    ...
    Public Function build_primitive_data(ByVal _add As Boolean) As Boolean
        ...
        For i = 0 To 99
            If b_reader.BaseStream.Position < File_len - 4 Then
                ...
                Next
                section_names(xmlget_mode).names(i) = na
